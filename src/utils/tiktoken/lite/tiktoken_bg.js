...
export class Tiktoken {
  ...
  free() {
    if (wasm == null)
      throw new Error(
        '@dqbd/tiktoken: WASM binary has not been propery initialized.',
      );
...
export function __wbg_stringify_029a979dfb73aa17() {
...
export function __wbg_parse_3ac95b51fc312db8() {
